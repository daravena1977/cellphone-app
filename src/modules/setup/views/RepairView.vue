<template>
  ...
  <input v-model="newRepair.price" class="form-control mt-3 w-25" type="number" name="" id="" placeholder="Ingrese costo...">
...
export default {
  ...
  components: {
    SelectBrand: defineAsyncComponent(() => import('@/modules/setup/components/SelectBrand')),
    SelectModel: defineAsyncComponent(() => import('@/modules/setup/components/SelectModel')),
    SelectTypeRepair: defineAsyncComponent(() => import('@/modules/setup/components/SelectTypeRepair'))
  },
